...
static void setupFloatButton(void) {
    ...
    g_floatButton.frame = CGRectMake(
        screen.size.width - btnSize - 15,
        100,
        btnSize,
        btnSize
    );
...
static void handlePanGesture(UIPanGestureRecognizer *gesture) {
    ...
    CGPoint translation =
        [gesture translationInView:btn.superview];
    ...
    if (gesture.state == UIGestureRecognizerStateEnded) {
        ...
        CGFloat x =
            btn.center.x < screen.size.width / 2
                ? 35
                : screen.size.width - 35;
...
@interface VCamImagePickerControllerDelegate :
    NSObject
...
// ============================================================================
// Intercept frame delegate callback
// ============================================================================
